...
private CalendarView feriadoText;
  ...
  public FeriadoTela() {
      ...
      Icon icon = new ImageIcon(getClass().getResource("/com/myscrum/assets/calendar.png"));//Criando icone para os botões do calendar view
      ...
      salvarButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			if(feriadoText.getText().equals("") || descText.getText().equals("")) {
	            ...
	            escolha = JOptionPane.showConfirmDialog(null, "Deseja realmente cadastrar este feriado?", "Selecione uma opção", JOptionPane.YES_NO_OPTION);
      ...
      atualizarButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			if(feriadoText.getText().equals("") || descText.getText().equals("")) {
	            ...
	            escolha = JOptionPane.showConfirmDialog(null, "Deseja realmente atualizar este feriado?", "Selecione uma opção", JOptionPane.YES_NO_OPTION);
	            if(escolha == JOptionPane.YES_OPTION) {
			SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");   
			Date data_desejada = null;
			try {
